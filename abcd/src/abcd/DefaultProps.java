...
public class DefaultProps implements ActionListener, ItemListener
{
...
//				System.out.println(e.getStackTrace()[0]);
	...
	{
		private DefaultProps defaults;
		private String laf;

		protected ChangeLookAndFeelAction(DefaultProps defaults, String laf, String name)
		{
	...
	{
		DefaultProps application = new DefaultProps();
